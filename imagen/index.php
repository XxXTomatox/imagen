...
<!-- el svg es donde mandamos a llamar lo imajen -->
...
<!-- estos g son la imagen como tal y cada uno de estas en una capa de la imagen esta se puede obtener ren el mismo -->
<!-- ilustrator  -->
<g id="Capa_1">
        <g>
            <a xlink:title="1" xlink:href="https://www.crunchyroll.com/es"; target="blank" >
    ...
    <g id="Capa_3">
        <!-- en esla linea puedes poner un link para que cuando le demos click te mande al sitio -->
        <a xlink:title="color" xlink:href="https://www.crunchyroll.com/es" target="blank" >
